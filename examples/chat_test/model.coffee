...
Tmp = new Meteor.Collection("Tmp")
Aux = new Meteor.Collection("Aux")
l = new Sunny.Utils.Lock("db")
...
Meteor.methods
  ...
  #   l.wait(); try Tmp.insert(msg) finally l.release()

  #   sdebug "**** CCCCCCCC"    

  #   l.wait(); try Aux.insert(msg) finally l.release()
